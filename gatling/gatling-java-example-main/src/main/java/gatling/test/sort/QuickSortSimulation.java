...
public class QuickSortSimulation extends Simulation {
    ...
    ScenarioBuilder scn = scenario("Quick-sort simulation ").exec(quickSortingRequest("C:\\Users\\urban\\IdeaProjects\\frameworks-comparative-analysis\\gatling\\gatling-java-example-main\\src\\main\\resources\\test1.csv"));
