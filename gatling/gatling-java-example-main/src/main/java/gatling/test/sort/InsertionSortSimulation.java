...
public class InsertionSortSimulation extends Simulation {
    ...
    ScenarioBuilder scn = scenario("Bubble-Sort simulation ").exec(insertionSortingRequest("C:\\Users\\urban\\IdeaProjects\\frameworks-comparative-analysis\\gatling\\gatling-java-example-main\\src\\main\\resources\\test1.csv"));
